...
bool battery_state__msg__battery_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // led_states
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      int32_t * dest = ros_message->led_states.data;
...
PyObject * battery_state__msg__battery_msg__convert_to_py(void * raw_ros_message)
{
  ...
  {  // led_states
    ...
    if (ros_message->led_states.size > 0) {
      ...
      int32_t * src = &(ros_message->led_states.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->led_states.size * sizeof(int32_t));
      assert(data != NULL);
